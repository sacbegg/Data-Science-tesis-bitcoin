...
btc_plot + geom_vline(xintercept = as.Date("2017-01-01"), col = "red")+ geom_vline(xintercept = as.Date("2018-01-01"), col = "red")+ geom_vline(xintercept = as.Date("2019-01-01"), col = "red")+ geom_vline(xintercept = as.Date("2020-01-01"), col = "red")+ geom_vline(xintercept = as.Date("2021-04-01"), col = "red")+ geom_vline(xintercept = as.Date(max(index(btc_median_cmetric))), col = "red")
